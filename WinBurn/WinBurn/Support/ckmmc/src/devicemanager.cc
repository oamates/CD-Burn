...
namespace ckmmc
{
    ...
    void DeviceManager::close_device_handle(HANDLE handle)
    {
        driver_.close_device_handle(handle);
    }
    HANDLE DeviceManager::get_device_handle(ScsiDevice &device)
    {
        return driver_.get_device_handle(device);
    }
};
