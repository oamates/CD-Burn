	...
	TRSTR(GENERAL_ERROR /* 0x0000 */, _T("错误"))
	TRSTR(GENERAL_WARNING /* 0x0001 */, _T("警告"))

	TRSTR(GENERAL_INFORMATION /* 0x0002 */, _T("信息"))
	TRSTR(GENERAL_QUESTION /* 0x0003 */, _T("询问"))
	...
	TRSTR(ERROR_RELOADDRIVE /* 0x000c */, _T("请关闭程序及进程中的cdrecorder.exe后重新打开程序."))
	...
	TRSTR(INIT_SCANBUS /* 0x0014 */, _T("扫描 SCSI/IDE 总线..."))
	TRSTR(INIT_LOADCAPABILITIES /* 0x0015 */, _T("加载设备功能..."))
	TRSTR(STRINGTABLE_PLACEHOLDER0 /* 0x0016 */, _T(""))
	TRSTR(INIT_FOUNDDEVICES /* 0x0017 */, _T("硬盘配置信息已改变，是否更新？"))
	TRSTR(INIT_DEVICECD /* 0x0018 */, _T("初始化设备..."))
	TRSTR(INIT_TRACK /* 0x0019 */, _T("从磁道 %d 加载信息."))

	TRSTR(FAILURE_SCANBUS /* 0x001a */, _T("检测 SCSI/IDE 总线失败，请检查系统是否正确配置！"))
	TRSTR(FAILURE_LOADCAP /* 0x001b */, _T("加载设备功能失败！"))
	TRSTR(FAILURE_LOADINFOEX /* 0x001c */, _T("加载扩展的设备信息失败！"))
	TRSTR(FAILURE_NORECORDERS /* 0x001d */, _T("没有可用的刻录设备"))
	TRSTR(FAILURE_NODEVICES /* 0x001e */, _T("没有可用的设备"))
	TRSTR(FAILURE_CDRTOOLS /* 0x001f */, _T("执行cdrtools过程中出错，原因是不能执行选定操作."))
	TRSTR(FAILURE_NOMEDIA /* 0x0020 */, _T("加载盘失败，请插入光盘！"))
	TRSTR(FAILURE_UNSUPRW /* 0x0021 */,_T("刻录机中的光盘不支持可擦写！"))
	...
	TRSTR(FAILURE_LOADDRIVE /* 0x0029 */, _T("光驱不能自动加载."))
	...
	// Write modes.
	TRSTR(WRITEMODE_REAL /* 0x0072 */, _T("实时写"))	
	...
	TRSTR(COLUMN_NAME_TREE /* 0x007a */,		_T("Name"))
	TRSTR(COLUMN_SIZE /* 0x007b */,		_T("Size"))
	TRSTR(COLUMN_TYPE_TREE /* 0x007c */,		_T("Type"))
	...
	// Status dialog.
	TRSTR(PROGRESS_STATUS /* 0x0087 */,          _T("状态: "))
	TRSTR(PROGRESS_DEVICE /* 0x0088 */,		  _T("设备: "))
	TRSTR(PROGRESS_TOTAL /* 0x0089 */,			  _T("总进度: %d%%"))
	TRSTR(PROGRESS_INIT /* 0x008a */,			  _T("准备执行已选择的操作."))
	TRSTR(PROGRESS_DONE /* 0x008b */,			  _T("操作完成."))					
	TRSTR(PROGRESS_CANCELED /* 0x008c */,		  _T("操作取消."))
	TRSTR(PROGRESS_GRACETIME /* 0x008d */,		  _T("%d 秒钟后将开始刻录."))
	TRSTR(PROGRESS_BEGINERASE /* 0x008e */,	  _T("在%s模式下开始擦除光盘."))
	TRSTR(PROGRESS_BEGINFIXATE /* 0x008f */,	  _T("在%s模式下开始关闭对光盘操作."))
	TRSTR(PROGRESS_BEGINWRITE /* 0x0090 */,	  _T("在%s模式下开始写光盘数据."))
	TRSTR(PROGRESS_BEGINTRACK /* 0x0091 */,	  _T("开始写入磁道 %d."))			
	TRSTR(PROGRESS_BEGINDISCIMAGE /* 0x0092 */,  _T("开始写光盘镜像文件."))
	TRSTR(PROGRESS_IMAGEDEVICE /* 0x0093 */,	  _T("虚拟光盘镜像文件刻录"))
	TRSTR(PROGRESS_BEGINREADTRACK /* 0x0094 */,  _T("开始读磁道数据 %d."))
	TRSTR(PROGRESS_BEGINSCANTRACK /* 0x0095 */,  _T("开始扫描磁道 %d."))
	TRSTR(PROGRESS_BEGINREADDISC /* 0x0096 */,	  _T("开始读光盘."))				

	// Status strings.
	TRSTR(STATUS_ERASE /* 0x0097 */,       _T("擦除磁盘数据."))
	TRSTR(STATUS_WRITEDATA /* 0x0098 */,	_T("写光盘数据."))							// FIXME: Obsolete.	
	TRSTR(STATUS_WRITE /* 0x0099 */,		_T("以 %.1fx 速度写磁道 %d 中的磁道 %d ."))	// FIXME: Obsolete.	
	TRSTR(STATUS_WRITEPREGAP /* 0x009a */,	_T("Writing pregap for track %d at %ld."))		// FIXME: Obsolete.
	TRSTR(STATUS_FILLBUFFER /* 0x009b */,	_T("等待读进程存放数据到输入缓存."))	// FIXME: Obsolete.	
	TRSTR(STATUS_FIXATE /* 0x009c */,		_T("关闭对磁盘操作."))							// FIXME: Obsolete.	
	TRSTR(STATUS_WRITEIMAGE /* 0x009d */,	_T("正在写光盘镜像文件."))
	TRSTR(STATUS_READTRACK /* 0x009e */,	_T("读磁道."))
	TRSTR(STATUS_SCANTRACK /* 0x009f */,	_T("扫描磁道."))
	...
	TRSTR(STATUS_READDISC /* 0x00a2 */,	_T("读取磁盘."))							// FIXME: Obsolete.	

	// Status titles.
	TRSTR(STITLE_ERASE /* 0x00a3 */,          _T("擦除磁盘数据"))
	TRSTR(STITLE_BURNIMAGE /* 0x00a4 */,	   _T("刻录镜像文件"))
	TRSTR(STITLE_CREATEIMAGE /* 0x00a5 */,	   _T("创建镜像文件"))
	TRSTR(STITLE_BURNCOMPILATION /* 0x00a6 */,_T("编制刻录盘"))
	TRSTR(STITLE_FIXATE /* 0x00a7 */,		   _T("关闭对磁盘操作"))
	TRSTR(STITLE_READTRACK /* 0x00a8 */,	   _T("读磁道"))
	TRSTR(STITLE_SCANTRACK /* 0x00a9 */,	   _T("扫描磁道"))
	TRSTR(STITLE_COPYDISC /* 0x00aa */,	   _T("光盘复制"))

	// Sucess messages.
	TRSTR(SUCCESS_ERASE /* 0x00ab */,       _T("光盘擦除成功."))
	TRSTR(SUCCESS_WRITE /* 0x00ac */,		 _T("数据成功的写入磁盘."))// FIXME: Obsolete.
	TRSTR(SUCCESS_FIXATE /* 0x00ad */,		 _T("磁盘关闭成功."))				// FIXME: Obsolete.
	TRSTR(SUCCESS_CREATEIMAGE /* 0x00ae */, _T("光盘镜像文件生成成功."))
	TRSTR(SUCCESS_READTRACK /* 0x00af */,	 _T("完成磁道 %d 的读取."))
	TRSTR(SUCCESS_SCANTRACK /* 0x00b0 */,	 _T("完成磁道 %d 的扫描."))
	TRSTR(SUCCESS_READDISC /* 0x00b1 */,	 _T("完成磁盘读操作."))								// FIXME: Obsolete.
	...
	TRSTR(ERROR_ESTIMAGESIZE /* 0x00e1 */,			  _T("计算文件系统大小过程中发生错误，程序不能继续进行."))
	TRSTR(PROGRESS_ESTIMAGESIZE /* 0x00e2 */,		  _T("正在计算文件系统大小."))
	...
	TRSTR(PROGRESS_RELOADMEDIA /* 0x00f9 */,	  _T("重新加载媒体文件."))
	...
	TRSTR(PROGRESS_FAILED /* 0x0130 */,	  _T("操作失败."))
	TRSTR(FAILURE_CREATEIMAGE /* 0x0131 */,  _T("光盘镜像文件生成失败."))
	...
	TRSTR(STITLE_VERIFYDISC /* 0x0139 */,	  _T("检验磁盘"))
