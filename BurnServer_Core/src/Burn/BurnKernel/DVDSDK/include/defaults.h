...
public:
	...
	~UDF_DefaultInfo(){};
public:
	PrimaryVolDesc      			*pDefault_pvd;
	LogicalVolDesc      			*pDefault_lvd;
	VolDescPtr          			*pDefault_vdp;
	ImpUseVolDescImpUse 			*pDefault_iuvdiu;
	ImpUseVolDesc       			*pDefault_iuvd;
	PartitionDesc       			*pDefault_pd;
	UnallocSpaceDesc    			*pDefault_usd;
	TerminatingDesc            		*pDefault_td;
	LogicalVolIntegrityDesc			*pDefault_lvid;
	LogicalVolIntegrityDescImpUse	*pDefault_lvidiu;
	SparingTable 			  		*pDefault_stable;
	SparablePartitionMap 			*pDefault_sparmap;
	VirtualAllocationTable15 		*pDefault_vat15;
	VirtualAllocationTable20 		*pDefault_vat20;
	VirtualPartitionMap 			*pDefault_virtmap;
	FileSetDesc 					*pDefault_fsd;
	FileEntry 						*pDefault_fe;
	ExtendedFileEntry 				*pDefault_efe;
};
