...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
#define LOG_SET_PATH(l)		if(g_pLog)			{g_pLog->SetLogPath(l);}
#define LOG_SET_LEVEL(l)	if(g_pLog)			{g_pLog->SetLogLevel(l);}
#define LOG_SET_SETSINGLELOOP(l)     if(g_pLog)   {g_pLog->SetSingleLoop(l);}
#define LOG_SET_LOOPTHRESHOLD(l)     if(g_pLog)   {g_pLog->SetLoopThreshold(l);}
#define LOG_SET_FIXNAME(l)           if(g_pLog)   {g_pLog->SetFixName(l);}
#define LOG_ERROR(s)		if(g_pLog)			{g_pLog->SetStackInfo(__FILE__,__FUNCTION__,__LINE__);g_pLog->LOGError		s;}
#define LOG_WARNING(s)		if(g_pLog)			{g_pLog->SetStackInfo(__FILE__,__FUNCTION__,__LINE__);g_pLog->LOGWarning	s;}
#define LOG_INFO(s)			if(g_pLog)			{g_pLog->SetStackInfo(__FILE__,__FUNCTION__,__LINE__);g_pLog->LOGInfo		s;}
#define LOG_DEBUG(s)		if(g_pLog)			{g_pLog->SetStackInfo(__FILE__,__FUNCTION__,__LINE__);g_pLog->LOGDebug		s;}
#define	DEBUG_OUT(s)		if(g_pLog)			{g_pLog->SetStackInfo(__FILE__,__FUNCTION__,__LINE__);g_pLog->Logout		s;}
#define	MESSAGE_OUT(s)		if(g_pLog)			{g_pLog->MessageOut	s;}
