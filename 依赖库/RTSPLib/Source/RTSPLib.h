 ...
 * called only once.
 */
RTSP_IN_EXPORT VOID RTSP_RTSP_Init(CONST CHNSYS_CHAR *sLogPath);
...
typedef struct _RTSP_CLIENT_RAWDATACBDATA_
{
    RTSP_CLIENT_HANDLE  hRTSPClient;
    CHNSYS_INT          nStreamNo;
    long                nTimestampSecond;/*seconds part*/
    long                nTimestampUSecond;/*useconds part*/
    CHNSYS_CHAR         *sData;
    CHNSYS_INT          nData;
    VOID                *pContext;
...
RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_SetEachTimeSendCount(RTSP_SERVER_HANDLE hRTSPServer, CHNSYS_INT nSendCount);

RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_SetPatchAudioFrame(RTSP_SERVER_HANDLE hRTSPServer, CHNSYS_BOOL bPatch);

RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_SetRTPPacketMaxSize(RTSP_SERVER_HANDLE hRTSPServer, CHNSYS_INT nMaxSize);

RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_GetRTPPacketMaxSize(RTSP_SERVER_HANDLE hRTSPServer);

RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_SetStreamMode(RTSP_SERVER_HANDLE hRTSPServer, CHNSYS_INT nStreamMode);

RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_GetStreamMode(RTSP_SERVER_HANDLE hRTSPServer);
...
RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_DisconnectAllClient(RTSP_SERVER_HANDLE hRTSPServer);
RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_SetMaxClientCount(RTSP_SERVER_HANDLE hRTSPServer,int nCount);
RTSP_IN_EXPORT CHNSYS_INT RTSP_SERVER_ResetSDPByAudio(RTSP_SERVER_HANDLE hRTSPServer, RTSP_SERVER_CONFIG config);

// for advance use;
RTSP_IN_EXPORT VOID RTSP_SERVER_SetSDP(RTSP_SERVER_HANDLE hRTSPServer, CHNSYS_CHAR *sSDP, CHNSYS_INT nSDP,CHNSYS_CHAR *sMultiAddr,CHNSYS_INT nMultiPort);
