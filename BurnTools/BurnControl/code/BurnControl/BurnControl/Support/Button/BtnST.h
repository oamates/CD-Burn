...
public:
    ...
    DWORD SetIcon(LPCTSTR lpszFileIconIn, LPCTSTR lpszFileIconOut);
    ...
    DWORD SetBitmaps(LPCTSTR lpszFileBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0);
